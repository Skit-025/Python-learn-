"""Here we have performed inheritance from one parent class and then that Derived class becomes the new parent class
...
class Employee:
    def __init__(self):
        print("Running the Employee class constructor")
    Company="Microsoft"
class Programmer(Employee):
    def __init__(self):
        print("Running the Programmer class constructor")
    language="Python"
class Manager(Programmer):
    def __init__(self):
        super().__init__()
        print("Running the Manager class constructor")
